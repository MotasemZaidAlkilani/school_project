...
private String add_type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if(add_type.equals("Add Class")) {
            LinearLayout l5=findViewById(R.id.liner_add_class);
        ...
        //spinner class material

        ArrayAdapter arrayAdapter_class=new ArrayAdapter(this,R.layout.support_simple_spinner_dropdown_item,materials_array);
        Spinner s4=findViewById(R.id.spinner_material);
        s4.setAdapter(arrayAdapter_class);



        //spinner Class supervisor

        ArrayAdapter arrayAdapter_class_supervisor=new ArrayAdapter(this,R.layout.support_simple_spinner_dropdown_item,materials_array);
        Spinner s5=findViewById(R.id.spinner_class_supervisor);
        s5.setAdapter(arrayAdapter_class_supervisor);
   ...
   TextView  t2 =findViewById(R.id.text_age_teacher);
      ...
      Spinner  teach=findViewById(R.id.spinner_teacher);
        teach.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
          ...
          // spinner add class , class supervisor

       Spinner class_sup=findViewById(R.id.spinner_class_supervisor);
        class_sup.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                item=parent.getSelectedItem().toString();
        ...
        // spinn add class material

       Spinner mater=findViewById(R.id.spinner_material);
        mater.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
...
public void move ()
{
    ...
    public void save_class (View v){
       userNameEditText =findViewById(R.id.edit_class_name);
       userSSNEditText =findViewById(R.id.edit_number_of_student);
       s1=findViewById(R.id.spinner_material);
        s2=findViewById(R.id.spinner_class_supervisor);
